...
AGAPES is not yet a finished autonomous drone system or a commercial product. At this stage, it is an applied research project focused on validating how well current computer vision models perform on real drone imagery in livestock and environmental monitoring contexts.
...
The value of AGAPES is to turn difficult-to-review visual data into useful information for decision-making. For ranching, this can support faster cattle counting, animal location, and field supervision. For environmental monitoring, it can help detect wildlife presence and reduce the amount of manual review needed.

AGAPES combines drones, computer vision, and field data to build a tool adapted to rural monitoring in northern Mexico.
